...
<body style="background: #fbfbfb;font-family: sans-serif;">
    <section style="width: 700px; margin: 50px auto;background-color: whitesmoke;">
        <div style="padding: 40px 20px;">
            ...
            <p style="font-size: 1.2rem;line-height: 1.6;">Hey {{$userName}}</p>
            <p style="font-size: 1.2rem;line-height: 1.6;">Trouble signing in? </p>
            <p style="font-size: 1.2rem;line-height: 1.6;">Resetting your password is easy. Use your secret code!  <strong>{{ $otp }}</strong></p>
            <p style="font-size: 1.2rem;line-height: 1.6; text-align: justify;">If you did not make this request then please ignore this email.
            </p>
            <p style="margin-bottom: 0.2rem; padding-bottom: 0.5rem;"><i>Sincerely</i></p>
