                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="media-photo.php">Media</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between mb-2 align-items-baseline text-end">
                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#photoUpload"
                                        class="btn btn-danger waves-effect waves-light me-2 mb-3" onclick="resetForm('mediaPhotoUploadForm','media_edit_photo','media_path_preview_container')">Upload</a>
                            ...
                            <div class="col-md-2">
                                <div class="card">
                                    ...
                                    <img class="rounded small_card-image" alt="200x200" width="100%"
                                        src="{{ asset($list->media_path) }}" data-holder-rendered="true">
                                    @else
                                    <img src="{{asset('assets/admin/images/noimg.jpg')}}" alt="200x200" width="100%"
                                        class="rounded small_card-image" data-holder-rendered="true">
                                    @endif
                                    <div class="px-3 py-2">
                                        <h4 class="fw-normal py-1">{{ $list->media_name }}</h4>
                                        <a href="javascript:void(0);"
                                            onclick="singleRecord('{{$list->id}}','{{URL::to('admin/single-media')}}','edit','photo')">
                                            <i class="fa-solid fa-pen-to-square text-danger fs-5"></i>
                                        </a>

                                        <a href="javascript:void(0);"
                                            onclick="singleRecord('{{$list->id}}','{{URL::to('admin/single-media')}}','detail','photo')">
